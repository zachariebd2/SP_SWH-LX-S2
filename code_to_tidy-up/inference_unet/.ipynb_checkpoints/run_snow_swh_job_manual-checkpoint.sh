...
#PBS -N INFERENCE
#PBS -j oe
#PBS -l select=1:ncpus=8:mem=49G:ngpus=1
#PBS -l walltime=11:59:59
#PBS -k n
#PBS -o /home/ad/barrouz/WORKSPACE/TIMESERIES_PROJECT/snow_code/logs
#PBS -e /home/ad/barrouz/WORKSPACE/TIMESERIES_PROJECT/snow_code/logs
#PBS -q qgpgpu  
#PBS -m abe
...
OUTPUT_SWH_PATH=/work/CAMPUS/etudes/Neige/CoSIMS/zacharie/TIMESERIES_PROJECT/ARTHUR_ALPS/OUTPUTS/SWH
OUTPUT_SNOW_PATH=/work/CAMPUS/etudes/Neige/CoSIMS/zacharie/TIMESERIES_PROJECT/ARTHUR_ALPS/OUTPUTS/UNET_TEST
